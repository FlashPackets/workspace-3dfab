...
cprequire_test(["inline:com-chilipeppr-workspace-3dfab"], function(ws) {
    ...
    $('title').html("3dfab Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-3dfab", ["3dfab_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-3dfab", // Make the id the same as the cpdefine id
        name: "Workspace / Sample", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for 3dfab.`,
